...
if ($_POST['submitted'] == 1) {
    ...
    $q = "UPDATE contact SET contact = '$content'";

    $r = mysqli_query($dbc, $q);

}

$q2 = "SELECT contact FROM contact";

$r2 = mysqli_query($dbc, $q2);

$contact = mysqli_fetch_assoc($r2);
    ...
    <div class="col-md-10">
        <form action="contact.php" method="post">
            ...
            <textarea class="form-control editor" name="content" id="content" rows="15"
                      placeholder="Contact Info"><?php echo $contact['contact']; ?></textarea>
            <!--SAVE button-->
